...
def evaluate_configuration(dataset_path: str, config_name: str, opensearch_client, index_name: str) -> dict:
...
if __name__ == "__main__":
    ...
    results_semantic = evaluate_configuration("golden_dataset.json", "chunking_semantic", client, "index_semantic")
    results_hierarchical = evaluate_configuration("golden_dataset.json", "chunking_hierarchical", client, "index_hierarchical")

    generate_comparison_report([results_semantic, results_hierarchical], output="report.html")